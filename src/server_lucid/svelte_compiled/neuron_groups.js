/* svelte_template/neuron_groups.html generated by Svelte v1.64.1 */
var neuron_groups = (function() { "use strict";
...
function data() {
  return {
	...
	function add_css() {
		...
		style.id = 'svelte-1m9e6kv-style';
		style.textContent = ".svelte-1m9e6kv.outer,.svelte-1m9e6kv .outer{width:224px;height:224px;display:inline-block;margin-right:2px;position:relative}.svelte-1m9e6kv.outer img,.svelte-1m9e6kv .outer img{position:absolute;left:0px;top:0px;width:224px;height:224px;image-rendering:pixelated}.svelte-1m9e6kv.factor,.svelte-1m9e6kv .factor{mix-blend-mode:lighten}.svelte-1m9e6kv.overlay,.svelte-1m9e6kv .overlay{filter:grayscale(100%) brightness(3);mix-blend-mode:multiply}.svelte-1m9e6kv.group,.svelte-1m9e6kv .group{width:80px;height:80px;margin-right:4px;display:inline-block;padding-top:10px}";
	...
	function create_main_fragment(component, state) {
		...
		return {
			...
			h: function hydrate() {
				...
				div.className = "figure svelte-1m9e6kv";
	...
	// (12:4) {{#if pres_n == undefined || pres_n == n}}
	...
	function neuron_groups(options) {
		init(this, options);
		this._state = assign(assign({ undefined : undefined }, data()), options.data);

		if (!document.getElementById("svelte-1m9e6kv-style")) add_css();
	...
	assign(neuron_groups.prototype, {
	 	destroy: destroy,
	 	get: get,
	 	fire: fire,
	 	observe: observe,
	...
	neuron_groups.prototype._recompute = noop;
