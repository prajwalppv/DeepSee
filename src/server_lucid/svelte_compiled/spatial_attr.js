/* svelte_template/spatial_attr.html generated by Svelte v1.64.1 */
var spatial_attr = (function() { "use strict";
...
function xs1(size1) {
  ...
  return {
	...
	function add_css() {
		...
		style.id = 'svelte-1qhxygu-style';
		style.textContent = ".svelte-1qhxygu.outer,.svelte-1qhxygu .outer{width:224px;height:224px;display:inline-block;margin-right:2px;position:relative}.svelte-1qhxygu.outer img,.svelte-1qhxygu .outer img,.svelte-1qhxygu.outer svg,.svelte-1qhxygu .outer svg{position:absolute;left:0px;top:0px;width:224px;height:224px;image-rendering:pixelated}.svelte-1qhxygu.attr,.svelte-1qhxygu .attr{opacity:0.6}.svelte-1qhxygu.pointer_container,.svelte-1qhxygu .pointer_container{z-index:100}.svelte-1qhxygu.pointer_container rect,.svelte-1qhxygu .pointer_container rect{opacity:0}.svelte-1qhxygu.pointer_container .selected,.svelte-1qhxygu .pointer_container .selected{opacity:1;fill:none;stroke:hsl(24, 100%, 50%);stroke-width:0.1px}.svelte-1qhxygu.label,.svelte-1qhxygu .label{position:absolute;left:0px;top:226px;width:224px}";
		appendNode(style, document.head);
	}

	function create_main_fragment(component, state) {
		var div, div_1, img, text, img_1, img_1_src_value, text_1, svg, svg_viewBox_value, text_2, div_2, text_3, text_5, div_3, img_2, text_6, img_3, img_3_src_value, text_7, svg_1, svg_1_viewBox_value, text_8, div_4, text_9;
		...
		return {
			c: function create() {
				...
				text_3 = createText(state.layer1);
				text_5 = createText("\n\n  ");
				...
				text_9 = createText(state.layer2);
				this.h();
			},
			...
			h: function hydrate() {
				...
				div.className = "figure svelte-1qhxygu";
	...
	spatial_attr.prototype._recompute = function _recompute(changed, state) {
		if (changed.size1) {
